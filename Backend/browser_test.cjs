...
async function runBrowserTest() {
  ...
  try {
    ...
    console.log('Opening feedback form panel...');
    await page.click('#openFormBtn');
    // New UI uses #formPanel (same as complaint page pattern)
    await page.waitForSelector('#formPanel', { visible: true });
    ...
    await page.waitForSelector('.feedback-item', { visible: true, timeout: 8000 });
